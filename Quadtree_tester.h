...
void Quadtree_tester<Object>::process() {
	...
	if ( command == "size" ) {
		...
		double temp_diff = actual_min_x - expected_min_x;

		if (fabs(temp_diff) < epsilon ) {
			std::cout << "Okay" << std::endl;
		} else {
		...
		double temp_diff = actual_min_y - expected_min_y;
		if (fabs(temp_diff) < epsilon ) {
			std::cout << "Okay" << std::endl;
		} else {
		...
		double temp_diff = actual_max_x - expected_max_x;
		if (fabs(temp_diff) < epsilon ) {
			std::cout << "Okay" << std::endl;
		} else {
		...
		double temp_diff = actual_max_y- expected_max_y;
		if (fabs(temp_diff) < epsilon ) {
			std::cout << "Okay" << std::endl;
		} else {
		...
		double temp_diff = actual_sum_x - expected_sum_x;
		if (fabs(temp_diff) < epsilon ) {
			std::cout << "Okay" << std::endl;
		} else {
		...
		double temp_diff = actual_sum_y - expected_sum_y;
		if (fabs(temp_diff) < epsilon ) {
			std::cout << "Okay" << std::endl;
		} else {
